...
compileAndModule "com.app" "com.app.Main"

$JAVA9_BIN/java -p modules --add-modules ALL-MODULE-PATH   -cp libs/com.level2.jar:libs/com.level1.jar:libs/com.app.jar   -m com.app
