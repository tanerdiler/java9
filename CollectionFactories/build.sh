...
rm -rf bin
mkdir -p bin/com.collectionfactories
...
compileAndJar "com.collectionfactories"
mv libs/com.collectionfactories.jar modules/.

$JAVA9_BIN/java --add-modules  ALL-MODULE-PATH -p modules   com.collectionfactories.Sample  #-m com.app.Main
